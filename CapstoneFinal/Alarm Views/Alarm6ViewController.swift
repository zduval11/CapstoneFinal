...
class Alarm6ViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
   ...
   datePicker.datePickerMode = UIDatePicker.Mode.time
    ...
    @IBAction func SetButtonTapped(_ sender: Any) {
            ...
            db.collection("users").document(Auth.auth().currentUser!.uid).collection("Alarm 6").document("Alarm 6 Info").setData(["Medication": MedName.text!, "Amount": AmountMed.text!, "Set Date": strDate, "URL": url])
